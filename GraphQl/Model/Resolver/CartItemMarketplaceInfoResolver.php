...
class CartItemMarketplaceInfoResolver implements ResolverInterface
{
    ...
    public function resolve(Field $field, $context, ResolveInfo $info, array $value = null, array $args = null)
    {
        ...
        return [
            ...
            'base_shipping_excl_tax'          => ['value' => $cartItem->getMiraklBaseShippingExclTax(), 'currency' => $baseCurrency],
            'shipping_excl_tax'               => ['value' => $cartItem->getMiraklShippingExclTax(), 'currency' => $currency],
            'base_shipping_incl_tax'          => ['value' => $cartItem->getMiraklBaseShippingInclTax(), 'currency' => $baseCurrency],
            'shipping_incl_tax'               => ['value' => $cartItem->getMiraklShippingInclTax(), 'currency' => $currency],
