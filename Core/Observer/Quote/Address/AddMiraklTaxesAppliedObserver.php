...
class AddMiraklTaxesAppliedObserver implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        foreach ($quote->getAllItems() as $item) {
            if ($item->getMiraklCustomTaxApplied() && ($customTaxApplied = unserialize($item->getMiraklCustomTaxApplied()))) {
            ...
            } elseif ($item->getMiraklShippingTaxApplied() && ($miraklShippingTaxApplied = unserialize($item->getMiraklShippingTaxApplied()))) {
