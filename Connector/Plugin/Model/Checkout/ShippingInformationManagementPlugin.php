...
class ShippingInformationManagementPlugin
{
    ...
    public function aroundSaveAddressInformation(
        ...
        if ($shippingAddress = $addressInformation->getShippingAddress()) {
            ...
            if ($extAttributes && $extAttributes->getAdditionalMethods()) {
        ...
        if ($shippingAddress && !$shippingAddress->getShippingMethod()) {
            $shippingCarrierCode = (string) $addressInformation->getShippingCarrierCode();
            $shippingMethodCode = (string) $addressInformation->getShippingMethodCode();
