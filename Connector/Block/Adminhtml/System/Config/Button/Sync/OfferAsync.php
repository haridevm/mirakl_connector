...
class OfferAsync extends AbstractButtons
{
    /**
     * @var array
     */
    protected $buttonsConfig = [
        [
            ...
            'url' => 'mirakl/sync/offerAsync',
            'confirm' => 'Are you sure? This will update all modified offers since the last synchronization.',
            'class' => 'scalable',
            'config_path' => \Mirakl\Connector\Helper\Config::XML_PATH_OFFERS_IMPORT_ASYNC_ENABLE,
        ],
        [
            'label' => 'Reset Date',
            'url' => 'mirakl/reset/offerAsync',
