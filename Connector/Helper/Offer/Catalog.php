...
class Catalog extends AbstractHelper
{
     ...
     * @return $this
     */
    public function updateAttributes(array $allSkus = [], $chunkSize = null)
    {
        if (null === $chunkSize) {
            $chunkSize = $this->chunkSize;
        }

        foreach (array_chunk($allSkus, $chunkSize) as $skus) {
    ...
    public function updateAttribute($attrCode, $offerTableField, $customTable, array $skus = [])
    {
        ...
        } catch (DeadlockException | DuplicateException $e) {
