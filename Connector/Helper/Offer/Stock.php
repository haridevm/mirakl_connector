...
class Stock extends AbstractHelper
{
    ...
    public function updateInStock(array $skus = [])
    {
        ...
        /** @var \Mirakl\Core\Model\ResourceModel\Product\Collection $productCollection */
        $productCollection = $this->productCollectionFactory->create();
        $parentProducts = $productCollection->getParentProductIds($productIds);
        foreach ($parentProducts as $parentProductIds) {
            $productIds = array_merge_recursive($productIds, $parentProductIds);
        }
        ...
        // Update products stock status index
        $stockStatusTable = $this->stockResource->getTable('cataloginventory_stock_status');
