...
class Updater
{
    ...
    protected function resetQuoteShippingFields(CartInterface $quote)
    {
        $quote->setMiraklShippingZone(null)
            ->setMiraklBaseShippingFee(null) // @deprecated
            ->setMiraklShippingFee(null) // @deprecated
            ->setMiraklBaseShippingExclTax(null)
            ->setMiraklShippingExclTax(null)
            ->setMiraklBaseShippingInclTax(null)
            ->setMiraklShippingInclTax(null)
    ...
    {
        // Set shipping method information on specified item
    ...
    public function setItemShippingFee(CartItemInterface $item, ShippingRateOffer $shippingRateOffer)
    {
        ...
        $item->setMiraklBaseShippingExclTax($shippingBaseExclTax);
        $item->setMiraklShippingExclTax($shippingExclTax);
        $item->setMiraklBaseShippingInclTax($shippingBaseInclTax);
        $item->setMiraklShippingInclTax($shippingInclTax);
